...
export const Contact = () => {
  ...
  return (
    <section className="w-full min-h-screen relative flex flex-col justify-center py-24 md:py-32 bg-slate-900 border-t border-slate-800" id="contact">
      <FadeIn className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-7">
            ...
            >
              {/* Lente Fixa no Mobile (Canto Superior Direito) */}
              <div 
                className={`absolute -top-32 -right-32 w-64 h-64 rounded-full blur-[80px] z-0 transition-colors duration-700 ${
                  isFocused ? "bg-sky-500/30" : "bg-sky-500/10"
                }`}
              />
